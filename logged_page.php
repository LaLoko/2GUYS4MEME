...
<html lang="pl">
   ...
   <body class="style" style="background-color:#333333">
      <div class="row" style="background-color:black;max-width:100%">
         ...
         <div class="col">
           <form action="dodaj.php" method="post">
            <input type="file" name="plik" class="form-control-file border" style="background-color:black;color:gold;border-color:gold">
            <input type="text" name="nazwa_mema" class="form-control" placeholder="NAZWA MEMA" style="background-color:black;color:gold;border-color:gold">
            <button type="submit" class="btn btn-outline-warning btn-lg">DODAJ MEMA</button>
          </form>
         </div>
           ...
           <?php echo '<img onclick="profil()" class="img-fluid" style="width:120px;height:120px" src="data:image/jpeg;base64,'.base64_encode( $_SESSION["awatar"] ) .'" alt="awatar">'?>
            <div class="col">
              ...
              <form action="logout.php" method="post">
                <input type="submit" class="btn btn-outline-warning btn-lg" value="WYLOGUJ SIE">
              </form>
            </div>
         </div>
      </div>
      <div style="padding-top:20px">
        ...
        echo "<row>";
        echo "<form action='logged_meme_page.php' method='post'><input type='submit' value='KOMENTARZE' class='btn btn-outline-warning'></form>";
